...
- [analysis/01-identifying-home-locations.Rmd](analysis/01-identifying-home-locations.md): Identifying home locations for users by using four built-in 'recipes' in [homelocator](https://github.com/spatialnetworkslab/homelocator) package
